...
export const metadata: Metadata = {
  title: 'Privacy Policy – ClearwayWeb',
}
  ...
  return (
    <main className="min-h-screen bg-white px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-serif text-charcoal-900 mb-6">Privacy Policy</h1>
        <p className="text-charcoal-500 text-sm font-light mb-4">
          This is a placeholder page. Replace with your actual privacy policy before launching.
        </p>
